...
export default function Home() {
  ...
  return (
    <div className="space-y-16 py-8">
      ...
      >
        <p className="mb-4 font-(family-name:--font-space-mono) text-xs tracking-[4px] text-[#ff2d55]">
          — LIVE EVENT PLATFORM
        </p>
        <h1 className="font-(family-name:--font-bebas-neue) text-5xl leading-tight tracking-tight text-[#f0eff5] md:text-7xl">
          ライブイベントを、<br />もっと身近に。
        </h1>
        <p className="mt-5 max-w-xl text-base leading-relaxed text-[rgba(240,239,245,0.65)]">
      ...
      <section className="grid grid-cols-1 gap-px md:grid-cols-3">
        {[
          ...
          <article
            key={feature.title}
            className="group relative bg-[#0d0d12] border border-[rgba(255,255,255,0.08)] p-8 transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(255,255,255,0.15)]"
          >
            <div
